 ...
 * Data da Ultima Alteração: 11 NOV 2019
 */
   ...
   * 24= Menu Selecionar: Configuracoes 2
   ...
   */
    ...
    */
     ...
     * @RSED & Filename & @ - Read Serial Eventes Data - Pedido de leitura do ficheiro guardado no cartão SD
     * @RSSN@ - Read Serial Serial Number - Ler o Numero de Serie e mês/ano de fabrico
     * @SDFD@ - SD File Delete - Command to Delete File
     * 
     * Comandos do Arduino -> VB
     * Envio de dados apartir do ficheiro no Cartão SD--> Acess SD Card - Open File Name requested - Send--> |Dia|Mes|Ano|Hora|Minuto|Temp|Hum .....
     * Enviar Informação do Controlador --> |SN|Mes|Ano
     * Respostas de Erro 
...
String DeviceModel = "ATmega Temp-01"; //Tipo de aparelho --> nome nao deve ser mais longo que 18 caracteres
String DeviceSN = "2019110001"; // Numero de Serie 10 caracteres 
int DeviceMonth = 11; // Mes de Fabrico
...
boolean FlgPulse1s=false;
unsigned long CntPreviousPulse1s = 0;  
int Pulse1s=1000; 
...
// Rotina Multitask para Pulse 1s
  unsigned long CntPulse1s = millis();
  if (CntPulse1s - CntPreviousPulse1s >= Pulse1s) {   
      CntPreviousPulse1s = CntPulse1s;
      FlgPulse1s=true;
    }
  else{
    FlgPulse1s=false;
...
*/
 ...
 if (FlgPulse1s==true){ //***************************** Rotina de Chamada de 1 Segundo ****************************************************
...
void Screen23(){
    ...
    tft.drawRect(35,95,250,40,WHITE);
    tft.drawRect(34,96,250,38,WHITE);    
    tft.setCursor(73,108);
    tft.setTextColor(WHITE);
    tft.setTextSize(2);
    tft.print("Inverter Saida");
